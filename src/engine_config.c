...
/* Construct types for MPI communications */
  ...
  /*TODO: Do this properly so we have a tester variables that we can set as params and read in*/
  int bundle_size = parser_get_param_int(params, "Scheduler:gpu_pack_size");
  int tester_var = parser_get_param_int(params, "Scheduler:gpu_tester_param");
  ...
  gpu_pack_params_set(&e->gpu_pack_params, pack_size, bundle_size,
                      gpu_recursion_max_depth, gpu_part_buffer_size,
                      e->s->eta_neighbours, nparts_hydro, n_top_level_cells,
                      nthreads, tester_var);
