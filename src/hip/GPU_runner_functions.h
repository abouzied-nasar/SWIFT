#ifndef HIP_HEADERS_H
#define HIP_HEADERS_H
...
void launch_density_pair_two_kernels(
    ...
    const char *loop_type, hipStream_t stream, int bid, int block_size,
...
void runner_dopair1_branch_density_gpu(
    ...
    hipStream_t stream, int bid, int block_size, int count_tasks,
...
void runner_dopairci_branch_density_gpu_aos_f4(
    ...
    float d_a, float d_H, hipStream_t stream, int numBlocks_x, int numBlocks_y,
