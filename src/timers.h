...
enum {
  ...
  timer_doself_gpu_pack_d,
  timer_doself_gpu_pack_g,
  timer_doself_gpu_pack_f,
  ...
  timer_dopair_gpu_unpack_d,
  timer_dopair_gpu_unpack_g,
  timer_dopair_gpu_unpack_f,
  timer_dopair_gpu_launch_d,
