 ...
 */
__global__ __attribute__((always_inline)) INLINE void cuda_kernel_self_density(
 ...
 */
__global__ __attribute__((always_inline)) INLINE  void cuda_kernel_self_gradient(
 ...
 */
__global__  __attribute__((always_inline)) INLINE void cuda_kernel_self_force(
