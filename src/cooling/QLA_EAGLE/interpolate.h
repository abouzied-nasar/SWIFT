 ...
 *
 ******************************************************************************/
#ifndef SWIFT_INTERPOL_QLA_EAGLE_H
#define SWIFT_INTERPOL_QLA_EAGLE_H

/**
 * @file src/cooling/QLA_EAGLE/interpolate.h
 * @brief Interpolation functions for QLA_EAGLE tables
 */
